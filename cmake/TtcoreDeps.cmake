...
if (TTCORE_STATIC_FFMPEG)
    ...
    if (EXISTS "C:/msys64/mingw64/lib")
        list(APPEND AVFORMAT_LIBRARY_DIRS "C:/msys64/mingw64/lib")
    endif()
    set(AVCODEC_LIBRARY_DIRS "${AVFORMAT_LIBRARY_DIRS}")
    set(AVUTIL_LIBRARY_DIRS "${AVFORMAT_LIBRARY_DIRS}")
    set(SWRESAMPLE_LIBRARY_DIRS "${AVFORMAT_LIBRARY_DIRS}")
    ...
    set(AVFORMAT_LIBRARIES
        ...
        "${_ff_lib}/libavutil.a"
        z iconv bcrypt ole32 user32 atomic)
